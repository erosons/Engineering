...
engine = create_engine("mysql://root:airflow@localhost:33306/test")
...
args = {
    ...
    "retries": 1,
    "owner": "Samson",
    "email": "awsengineerdevops@gmail.com",
...
with DAG(
    ...
    def extract_data(contn):
        ...
        return print("Operation was succesfully")
    ...
    email_task = EmailOperator(
        task_id="send_email",
        to="awsengineerdevops@gmail.com",
        subject="Airflow Alert",
        html_content=""" <h3> Email for test airflow </h3> """,
    )

    extract_orders_task >> test_bash.set_upsteam >> email_task
